module.exports = grammar({
  ...
  rules: {
    ...
    status: $ => choice($.status_done, $.status_wip, $.status_todo, $.status_awaiting),
    status_done: $ => token(prec(10, 'DONE')),
    status_wip: $ => token(prec(10, 'WIP')),
    status_todo: $ => token(prec(10, 'TODO')),
    status_awaiting: $ => token(prec(10, 'AWAITING')),
    arrow: $ => choice('->', '=>', '→'),
